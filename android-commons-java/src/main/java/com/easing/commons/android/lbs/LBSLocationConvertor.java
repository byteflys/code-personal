...
public class LBSLocationConvertor {
    ...
    public static LBSLocation WGS84_GCJ02(LBSLocation sourceLocation) {
        ...
        BeanUtil.copyAttribute(sourceLocation, destLocation);
        destLocation.latitude =Maths.keepFloat2(latitude + dLat, 6) ;
        destLocation.longitude = Maths.keepFloat2(longitude + dLng, 6);
        return destLocation;
    }
