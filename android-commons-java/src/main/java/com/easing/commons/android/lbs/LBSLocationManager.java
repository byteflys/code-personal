    ...
    public static void requestLocation(Context ctx, OnLocationGet onLocationGet) {
        ...
        LocationListener listener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                if (accuracy < 5) lbsLocation.accuracy = LBSLocation.SIGNAL_STRONG;
                if (accuracy < 20) lbsLocation.accuracy = LBSLocation.SIGNAL_MEDIUM;
                if (accuracy < 100) lbsLocation.accuracy = LBSLocation.SIGNAL_WEAK;
                else lbsLocation.accuracy = LBSLocation.SIGNAL_BAD;
