...
public class TabItemM2 extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrSet) {
        ...
        slideWidth = (int) attrs.getDimension(R.styleable.TabItemM2_slideWidth, ViewGroup.LayoutParams.MATCH_PARENT);
        ...
        LayoutParams lp2 = new LayoutParams(slideWidth, Dimens.toPx(context, 3), 0);
