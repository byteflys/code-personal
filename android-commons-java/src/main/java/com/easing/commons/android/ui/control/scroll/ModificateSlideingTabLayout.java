...
/**
 * 配合viewpager 使用的TabLayout
 */
public class ModificateSlideingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private boolean textSelectSize = false;
    ...
    public ModificateSlideingTabLayout(Context context) {
        this(context, null, 0);
    }

    public ModificateSlideingTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ModificateSlideingTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        textSelectSize = ta.getBoolean(R.styleable.SlidingTabLayout_tl_divider_padding, false);
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            if (tv_tab_title != null) {
                ...
                tv_tab_title.setTextSize(TypedValue.COMPLEX_UNIT_PX, i == mCurrentTab ? sp2px(20) : mTextsize);
    ...
    //选中字体是否变大
    public void setTextSelectSize(boolean textSelectSize) {
