...
public class SuperTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    private void initAttrs(AttributeSet attrs) {
        if (attrs != null) {
            ...
            TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.SuperTextView);
            corner = typedArray.getDimension(R.styleable.SuperTextView_corner, DEFAULT_CORNER);
            leftTopCornerEnable = typedArray.getBoolean(R.styleable.SuperTextView_left_top_corner, false);
            rightTopCornerEnable = typedArray.getBoolean(R.styleable.SuperTextView_right_top_corner, false);
            leftBottomCornerEnable = typedArray.getBoolean(R.styleable.SuperTextView_left_bottom_corner, false);
            rightBottomCornerEnable = typedArray.getBoolean(R.styleable.SuperTextView_right_bottom_corner, false);
            solid = typedArray.getColor(R.styleable.SuperTextView_solid, DEFAULT_SOLID);
            strokeWidth = typedArray.getDimension(R.styleable.SuperTextView_stroke_width, DEFAULT_STROKE_WIDTH);
            strokeColor = typedArray.getColor(R.styleable.SuperTextView_stroke_color, DEFAULT_STROKE_COLOR);
            drawable = typedArray.getDrawable(R.styleable.SuperTextView_state_drawable);
            drawableWidth = typedArray.getDimension(R.styleable.SuperTextView_state_drawable_width, 0);
            drawableHeight = typedArray.getDimension(R.styleable.SuperTextView_state_drawable_height, 0);
            drawablePaddingLeft = typedArray.getDimension(R.styleable.SuperTextView_state_drawable_padding_left, 0);
            drawablePaddingTop = typedArray.getDimension(R.styleable.SuperTextView_state_drawable_padding_top, 0);
            drawable2 = typedArray.getDrawable(R.styleable.SuperTextView_state_drawable2);
            drawable2Width = typedArray.getDimension(R.styleable.SuperTextView_state_drawable2_width, 0);
            drawable2Height = typedArray.getDimension(R.styleable.SuperTextView_state_drawable2_height, 0);
            drawable2PaddingLeft = typedArray.getDimension(R.styleable.SuperTextView_state_drawable2_padding_left, 0);
            drawable2PaddingTop = typedArray.getDimension(R.styleable.SuperTextView_state_drawable2_padding_top, 0);
            isShowState = typedArray.getBoolean(R.styleable.SuperTextView_isShowState, false);
            drawableAsBackground = typedArray.getBoolean(R.styleable.SuperTextView_drawableAsBackground, false);
            isShowState2 = typedArray.getBoolean(R.styleable.SuperTextView_isShowState2, false);
            stateDrawableMode = typedArray.getInteger(R.styleable.SuperTextView_state_drawable_mode, DEFAULT_STATE_DRAWABLE_MODE);
            stateDrawable2Mode = typedArray.getInteger(R.styleable.SuperTextView_state_drawable2_mode, DEFAULT_STATE_DRAWABLE_MODE);
            textStroke = typedArray.getBoolean(R.styleable.SuperTextView_text_stroke, false);
            textStrokeColor = typedArray.getColor(R.styleable.SuperTextView_text_stroke_color, DEFAULT_TEXT_STROKE_COLOR);
            textFillColor = typedArray.getColor(R.styleable.SuperTextView_text_fill_color, DEFAULT_TEXT_FILL_COLOR);
            textStrokeWidth = typedArray.getDimension(R.styleable.SuperTextView_text_stroke_width, DEFAULT_TEXT_STROKE_WIDTH);
            autoAdjust = typedArray.getBoolean(R.styleable.SuperTextView_autoAdjust, false);
            shaderStartColor = typedArray.getColor(R.styleable.SuperTextView_shaderStartColor, 0);
            shaderEndColor = typedArray.getColor(R.styleable.SuperTextView_shaderEndColor, 0);
    ...
    private void drawStrokeLine(Canvas canvas) {
        if (strokeWidth > 0) {
            ...
            strokeLineRectF.set(strokeWidth / 2, strokeWidth / 2, width - strokeWidth / 2, height - strokeWidth / 2);
            getCorners(corner);
    ...
    private void checkPressColor(Canvas canvas) {
        if (pressBgColor != Color.TRANSPARENT || pressTextColor != -99) {
            if (pressAdjuster == null) {
                pressAdjuster = new PressAdjuster(pressBgColor).setPressTextColor(pressTextColor).setType(Adjuster.TYPE_SYSTEM);
    ...
    public static class DefaultAdjuster extends Adjuster {
        ...
        public void adjust(SuperTextView v, Canvas canvas) {
            ...
            float[] textSizes = {37.21f, 37.21f, 24.81f, 27.9f, 24.81f, 22.36f, 18.6f, 18.6f};
            switch (length) {
                case 1:
