...
public class Animations {
    ...
    public static final TranslateAnimation TRANSLATE_UP = Animations.translate(0f, 0f, 0f, -1f, 0.5f);
    public static final TranslateAnimation TRANSLATE_DOWN = Animations.translate(0f, 0f, -1f, 0f, 0.5f);
