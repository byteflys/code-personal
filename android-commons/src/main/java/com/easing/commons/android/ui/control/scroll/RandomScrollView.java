...
//可以横竖滑动的滚动控件
public class RandomScrollView extends FrameLayout {

    //处理滑动的Scroller 这里如果是api9以上最好使用OverScroller代替Scroller
    //Scroller的速滑效果很差
    ...
    public RandomScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public RandomScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
