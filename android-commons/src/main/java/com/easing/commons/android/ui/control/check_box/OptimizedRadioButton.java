package com.easing.commons.android.ui.control.check_box;
...
public class OptimizedRadioButton extends AppCompatRadioButton {
    /**
     * 默认缩放动画，缩放比例为3/4
     */
    ...
    public OptimizedRadioButton(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.OptimizedRadioButton);
        drawableSize = array.getDimensionPixelSize(R.styleable.OptimizedRadioButton_orb_drawable_size, DEFAULT_DRAWABLE_SIZE);
        scaleRate = array.getFloat(R.styleable.OptimizedRadioButton_orb_scale, DEFAULT_SCALE_RATE);
        duration = array.getInteger(R.styleable.OptimizedRadioButton_orb_duration, DEFAULT_DURATION);
        enableAnimation = array.getBoolean(R.styleable.OptimizedRadioButton_orb_animate, false);
