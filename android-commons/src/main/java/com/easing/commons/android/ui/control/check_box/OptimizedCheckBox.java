...
public class OptimizedCheckBox extends AppCompatCheckBox {
    /**
     * 默认缩放动画，缩放比例为3/4
     */
    ...
    public OptimizedCheckBox(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.OptimizedCheckBox);
        drawableSize = array.getDimensionPixelSize(R.styleable.OptimizedCheckBox_ocb_drawable_size, DEFAULT_DRAWABLE_SIZE);
        enableAnimation = array.getBoolean(R.styleable.OptimizedCheckBox_ocb_animate, false);
        scaleRate = array.getFloat(R.styleable.OptimizedCheckBox_ocb_scale, DEFAULT_SCALE_RATE);
        duration = array.getInteger(R.styleable.OptimizedCheckBox_ocb_duration, DEFAULT_DURATION);
